...
| Path | Justification |
| --- | --- |
| `.claude/**`, `.codex/**` | Agent and tool config copied from plugins; not repo documentation. |
| `DOCGRAPH.md`, `CODEX.md` | Generated by `docgraph context-init`; carry docgraph's own heading format. |
| `docs/issues/TEMPLATE.md` | Copy-me issue template with placeholder structure; also excluded from the docgraph index. |
